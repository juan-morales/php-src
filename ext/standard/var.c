...
/* {{{ Returns the representation of bytes into another memory unit */
...
{
	REGISTER_LONG_CONSTANT("MEMORY_UNIT_BYTE", MEMORY_UNIT_BYTE, CONST_CS|CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("MEMORY_UNIT_KILOBYTE", MEMORY_UNIT_KILOBYTE, CONST_CS|CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("MEMORY_UNIT_MEGABYTE", MEMORY_UNIT_MEGABYTE, CONST_CS|CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("MEMORY_UNIT_GIGABYTE", MEMORY_UNIT_GIGABYTE, CONST_CS|CONST_PERSISTENT);

	REGISTER_STRING_CONSTANT("MEMORY_UNIT_BYTE_SYMBOL", MEMORY_UNIT_BYTE_SYMBOL, CONST_CS|CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("MEMORY_UNIT_KILOBYTE_SYMBOL", MEMORY_UNIT_KILOBYTE_SYMBOL, CONST_CS|CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("MEMORY_UNIT_MEGABYTE_SYMBOL", MEMORY_UNIT_MEGABYTE_SYMBOL, CONST_CS|CONST_PERSISTENT);
	REGISTER_STRING_CONSTANT("MEMORY_UNIT_GIGABYTE_SYMBOL", MEMORY_UNIT_GIGABYTE_SYMBOL, CONST_CS|CONST_PERSISTENT);
